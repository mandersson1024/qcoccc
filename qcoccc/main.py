...
def main():
    ...
    personal = resolve_personal_interest_skills(context, exclude={name for name, _ in resolved}, personal_interest_weights=occ_data.get("personal_interest_weights"))
